...
export const metadata: Metadata = {
  ...
  description:
    "Meet Dr. Pooja Wadgaonkar Patil (MBBS, MS OBGY, FMAS, DNB), leading Obstetrician, Gynaecologist & Laparoscopic Surgeon in Hinjawadi (Hinjewadi), Pune. Dedicated to compassionate, evidence-based women's healthcare.",
  keywords: [
  ...
  twitter: {
    ...
    title: "About Dr. Pooja Wadgaonkar Patil | FemHealth Clinic Pune",
    description:
      "Consultant Obstetrician, Gynaecologist & Minimal Access Surgeon in Hinjawadi & Hinjewadi, Pune.",
